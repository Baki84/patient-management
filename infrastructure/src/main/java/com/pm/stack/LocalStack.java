...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "Wm8xY3pHb1lqNnVUZ1J2T0l1Wk1EYWJZQ1h2Y0pYV2J3Q2pTdFZkYlR3Z2h4R3FUa0V5cXlEZk9sWm1HYm5VYw=="));
    ...
    private DatabaseInstance createDatabase(String id, String dbName){
        return DatabaseInstance.Builder
                ...
                .allocatedStorage(20)
                .credentials(Credentials.fromGeneratedSecret("admin-user"))
                .databaseName(dbName)
    ...
    private FargateService createFargateService(String id,
        ...
        if(db != null){
            ...
            envVars.put("SPRING_DATASOURCE_USERNAME", "admin-user");
